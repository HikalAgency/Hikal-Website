    ...
    foreach ($cards as $index => $card) {
        ...
        <div class="expand-card" style="background-image: url('<?php echo $card['image']; ?>');"
            ...
            <div class="collapsed-content">
                <div class="d-flex items-center gap-2 text-start text-white">
                    <h4 className="text-white"><?php echo $card['title']; ?></h4>
                    <span>|</span>
                    <h4 className="text-white"><?php echo $card['country']; ?></h4>
                </div>
            </div>
