...
<div class="card-container">
    ...
    foreach ($cards as $index => $card) {
        ...
        <div class="expand-card" style="background-image: url('<?php echo $card['image']; ?>');"
            ...
            <div class="collapsed-content flex-column flex-md-row align-items-center justify-content-start gap-2 text-start text-white">
                <h5 class="text-white"><?php echo $card['title']; ?></h5>
                <span class="d-none d-md-flex">|</span>
                <h5 class="text-white"><?php echo $card['country']; ?></h5>
            </div>

            <div class="expanded-content align-items-end justify-content-start gap-2 text-start text-white">
