...
<div class="card-container">
    ...
    foreach ($cards as $index => $card) {
        ...
        <!-- <div class="expand-card"
            style="background-image: linear-gradient(180deg, rgba(217, 217, 217, 0) 0%, #000000 100%), url('<?php echo $card['image']; ?>');"
            data-index=""> -->
        <div class="expand-card" style="--card-bg: url('<?php echo $card['image']; ?>');"
            data-index="<?php echo $index; ?>">


            <div
                class="collapsed-content flex-column flex-md-row align-items-center justify-content-start gap-2 text-start text-white">
