...
<style>
    ...
    @media screen and (max-width: 750px) {
        .expand-card {
            background-image:
                linear-gradient(180deg, rgba(217, 217, 217, 0.1) 0%, rgba(0, 0, 0, 0.3) 100%),
                var(--card-image);
            height: 10vh;
        }
        .expand-card .expanded-content {
...
<div class="card-container">
    ...
    foreach ($cards as $index => $card) {
        ...
        <div class="expand-card" style="--card-image: url('<?php echo $card['image']; ?>');"
            ...
            <div
                class="collapsed-content position-relative flex-column flex-md-row align-items-md-center justify-content-start gap-2 text-start text-white">
