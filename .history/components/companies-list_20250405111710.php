...
<style>
    ...
    .expand-card .expanded-content {
        ...
        min-height: 90vh;
        width: 100%;
        position: relative; /* Contain the absolute header */
    }
    ...
    /* Hide the main header when a card is expanded */
    .card-container:has(.expand-card.active) + .companies-header {
        display: none;
    }
