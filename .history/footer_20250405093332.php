...
<footer class="my-5 pt-5">
    <h4 class="gold-grad-anim mb-2">Get in Touch</h4>
    <div class="divider"></div>
    <p class="mb-5">
        We’d love to hear from you! Fill out the form below, and our team will reach out shortly.
    </p>
    <div
        class="container container-fluid d-flex flex-column align-items-center justify-content-center gap-4 text-center pb-2 pt-5">
        <!-- LOGO -->
