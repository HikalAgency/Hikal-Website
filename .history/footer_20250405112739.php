...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const thankYou = document.getElementById('thank_you'); // Assuming you have this for success message
        const fillNote = document.getElementById('fill-note'); // Assuming you have this for error messages

        // Show form, hide thank you message initially (if applicable)
        ...
        const messageField = document.querySelector('#contactForm input[name="message"]'); // Assuming message field will be added
