                ...
                service.subservices.forEach(subservice => {
                    subServicesHtml += `
                        <div class="col-12 col-md-4 p-2">
                            <div class="p-4 text-center" style="background: linear-gradient(80.42deg, rgba(188, 171, 125, 0.0704) 25.25%, rgba(203, 183, 133, 0.16) 98.05%); border-radius: 20px; box-shadow: 5px 5px 10px #333333, -5px -5px 10px #555555;">
