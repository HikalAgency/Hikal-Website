...
<body>
    ...
    <div class="body-content">
        ...
        <!-- ABOUT -->
        <div id="about" class="container container-fluid my-5 py-5 text-center">
        ...
        <!-- CONTACT -->
        <div id="contact" class="container container-fluid my-5 py-5 text-center">
            ...
            <div class="row">
                <div class="col-12 col-md-4 p-2 px-5 px-md-2">
                    <div class="contact-card p-4 h-100">
                        <p class="text-black"><b>UNITED ARAB EMIRATES</b></p>
                        <p><small>1610, SIT Tower, Dubai Silicon Oasis, Dubai, UAE</small></p>
                    </div>
                </div>
                <div class="col-12 col-md-4 p-2 px-5 px-md-2">
                    <div class="contact-card p-4 h-100">
                        <p class="text-black"><b>EGYPT</b></p>
                        <p><small>51, Skies Plaza Mall, 90th Street, 5th Settlement, New Cairo, Egypt</small></p>
                    </div>
                </div>
                <div class="col-12 col-md-4 p-2 px-5 px-md-2">
                    <div class="contact-card p-4 h-100">
                        <p class="text-black"><b>PAKISTAN</b></p>
                ...
                service.subservices.forEach(subservice => {
                    subServicesHtml += `
                        <div class="col-12 col-md-4 p-2">
                            <div class="p-4 text-center" style="background: linear-gradient(80.42deg, rgba(188, 171, 125, 0.0704) 25.25%, rgba(203, 183, 133, 0.16) 98.05%); border-radius: 20px; border: 1.2px solid; border-image-source: linear-gradient(266.19deg, rgba(203, 183, 133, 0.6) -4.37%, rgba(203, 183, 133, 0.156) 100.99%); backdrop-filter: blur(16px);">
