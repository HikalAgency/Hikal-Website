...
<body>
    ...
    <div class="body-content">
        ...
        <!-- INTRO -->
        <div class="section container container-fluid my-6 py-6">
            <h4 class="gold-grad">
        ...
        <!-- COMPANIES -->
        <div id="companies" class="companies-section my-6 py-6">
        ...
        <!-- ABOUT -->
        <div id="about" class="container container-fluid my-6 py-6 text-center">
        ...
        <!-- CONTACT -->
        <div id="contact" class="container container-fluid my-6 py-6 text-center">
