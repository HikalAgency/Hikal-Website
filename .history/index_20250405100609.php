...
<body>
    ...
    <div class="body-content">
        ...
        <!-- COMPANIES -->
        <div id="companies" class="section companies-section my-5 py-5">
        ...
        <!-- SERVICES -->
        <div id="services" class="section py-5 container container-fluid my-5 text-center">
        ...
        <!-- ABOUT -->
        <div id="about" class="section container container-fluid my-5 py-5 text-center">
        ...
        <!-- CONTACT -->
        <div id="contact" class="section container container-fluid my-5 py-5 text-center">
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            function scrollToNextSection() {
                ...
                for (let i = 0; i < sections.length; i++) {
                    ...
                    // If top of current section is above 50% of viewport, scroll to next
                    if (sectionTop <= viewportHeight * 0.5 && sectionTop > -sectionHeight * 0.5) {
                        if (sections[i + 1]) {
                ...
                // Reset scroll block after animation delay
                setTimeout(() => {
                    isScrolling = false;
                }, 1000);
            }
            ...
            window.addEventListener("scroll", () => {
                ...
                window.scrollTimeout = setTimeout(scrollToNextSection, 150);
            });
        });
    </script>
