...
<body>
    ...
    <div class="body-content">
        ...
        <!-- INTRO -->
        <div class="section section1 container container-fluid my-5 py-5">
            <h3 class="gold-grad">
        ...
        <!-- COMPANIES -->
        <div id="companies" class="section section2 companies-section my-5 py-5">
        ...
        <!-- SERVICES -->
        <div id="services" class="section section3 py-5 container container-fluid my-5 text-center">
        ...
        <!-- ABOUT -->
        <div id="about" class="section section4 container container-fluid my-5 py-5 text-center">
        ...
        <!-- CONTACT -->
        <div id="contact" class="section section5 container container-fluid my-5 py-5 text-center">
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            window.addEventListener("scroll", () => {
                ...
                for (let i = 0; i < sections.length; i++) {
                    ...
                    if (rect.top < -rect.height / 2 && direction === "down" && i < sections.length - 1) {
                        scrollToSection(sections[i + 1]);
                        break;
                    }

                    if (rect.top > window.innerHeight / 2 && direction === "up" && i > 0) {
                        scrollToSection(sections[i - 1]);
                        break;
                    }
                }
