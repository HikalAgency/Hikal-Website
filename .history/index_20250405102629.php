    ...
    <script>
        ...
        window.addEventListener('scroll', () => {
            ...
            sections.forEach((section, index) => {
                ...
                // If the current section has passed 50% out of viewport
                if (topOffset < -windowHeight * 0.5 && index < sections.length - 1) {
                    isScrolling = true;
                    ...
                    setTimeout(() => {
                        isScrolling = false;
                    }, 800); // enough time for the smooth scroll to complete
                }
            });
        });
    </script>
