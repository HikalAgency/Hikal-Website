...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            let lastScrollTop = window.pageYOffset || document.documentElement.scrollTop; // Track scroll direction
            ...
            const observer = new IntersectionObserver(
                (entries) => {
                    ...
                    entries.forEach((entry) => {
                        // Only trigger when scrolling down and less than 50% of the section is visible
                        if (scrollingDown && (!entry.isIntersecting || entry.intersectionRatio < 0.5)) {
                            const currentSection = entry.target;
                            const nextSection = currentSection.nextElementSibling;
