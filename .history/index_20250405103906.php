            ...
            const observer = new IntersectionObserver(
                (entries) => {
                    ...
                    entries.forEach((entry) => {
                        ...
                        // Trigger when section is less than 50% visible and scrolling down
                        if (
                            scrollingDown &&
                            ...
                            console.log("Triggering scroll to next section:", nextSection);
                            console.log("Intersection Ratio:", entry.intersectionRatio, "Scrolling Down:", scrollingDown);
                            isAutoScrolling = true;
                            nextSection.scrollIntoView({ behavior: "smooth", block: "start" });

                            setTimeout(() => {
                                isAutoScrolling = false;
                            }, 1000); // Delay to prevent overlap
                        }
                    });
