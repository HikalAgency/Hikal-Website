...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            const sections = document.querySelectorAll(".section");
            console.log("Sections found:", sections.length, sections); // Confirm sections are detected
            ...
            const observer = new IntersectionObserver(
                (entries) => {
                    console.log("Observer triggered, entries:", entries.length); // Confirm observer is firing

                    if (isAutoScrolling) {
                        console.log("Skipping due to auto-scrolling");
                        return;
                    }
                    ...
                    entries.forEach((entry) => {
                        ...
                        if (!entry.isIntersecting || entry.intersectionRatio < 0.5) {
                            console.log("Section is less than 50% visible:", currentSection.className);
                            ...
                            if (nextSection && nextSection.classList.contains("section")) {
                                ...
                                console.log("No valid next section found");
                            }
                        }
                    });
                },
