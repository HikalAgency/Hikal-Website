...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            let isInitialLoad = true; // Prevent initial scroll
            let lastScrollTop = window.pageYOffset || document.documentElement.scrollTop; // Track direction
            ...
            const observer = new IntersectionObserver(
                (entries) => {
                    ...
                    entries.forEach((entry) => {
                        ...
                        // Only auto-scroll when scrolling down and section is < 50% visible
                        if (
                            scrollingDown &&
                    ...
                    lastScrollTop = currentScrollTop <= 0 ? 0 : currentScrollTop; // Update scroll position
                },
                {
                    threshold: 0.5,
                    rootMargin: "0px"
            ...
            // Disable initial load flag after a short delay
            setTimeout(() => {
                isInitialLoad = false;
