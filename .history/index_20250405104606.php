...
<body>
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const observer = new IntersectionObserver(
                (entries) => {
                    ...
                    entries.forEach((entry) => {
                        ...
                        // Auto-scroll when scrolling down and section is < 50% visible
                        if (
                            scrollingDown &&
                    ...
                    lastScrollTop = currentScrollTop <= 0 ? 0 : currentScrollTop; // Update after processing
                },
                {
                    threshold: 0.5,
                    rootMargin: "0px"
            ...
            // Update scroll position on manual scroll to ensure direction is tracked
