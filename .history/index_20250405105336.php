        ...
        document.addEventListener("DOMContentLoaded", () => {
            ...
            const observer = new IntersectionObserver(
                (entries) => {
                    ...
                    console.log("Observer Check - Scrolling Down:", scrollingDown, "Current ScrollTop:", currentScrollTop, "Last ScrollTop:", lastScrollTop);
                ...
                {
                    root: scrollContainer, // Observe relative to .body-content
                    threshold: 0.5,
                    rootMargin: "0px"
                }
            );
