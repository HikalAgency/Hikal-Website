...
<body>
    ...
    <script>
        ...
        //     let previousScrollTop = lastScrollTop; // Store the previous scroll position

        //     // Scroll listener on the container
        //     scrollContainer.addEventListener("scroll", () => {
        //         const currentScrollTop = scrollContainer.scrollTop || 0;
        //         console.log("Scroll Event - Current ScrollTop:", currentScrollTop, "Last ScrollTop:", lastScrollTop);
        //         previousScrollTop = lastScrollTop; // Store the previous value before updating
        ...
        //                 console.log("Skipping due to initial load or auto-scrolling");
        //                 return;
        //             }

        //             const currentScrollTop = scrollContainer.scrollTop || 0;
        //             const scrollingDown = currentScrollTop > previousScrollTop; // Compare with previous value
        //             console.log(
        //                 "Observer Check - Scrolling Down:", scrollingDown,
        //                 "Current ScrollTop:", currentScrollTop,
        //                 "Previous ScrollTop:", previousScrollTop
        //             );
        ...
        //                 ) {
        //                     console.log("Scrolling to next section:", nextSection.className);
        //                     isAutoScrolling = true;
        //                     nextSection.scrollIntoView({ behavior: "smooth", block: "start" });

        //                     setTimeout(() => {
        //                         isAutoScrolling = false;
        //                         console.log("Auto-scrolling reset");
        //                     }, 1000);
        //                 }
        //             });
        //         },
                ...
                (entries) => {
                    ...
                    entries.forEach((entry) => {
                        ...
                        if (
                            ...
                            console.log("Companies card expanded - skipping scroll to next section:", nextSection.className);
